...
if __name__ == '__main__':
    ...
    # 模型训练
    oof_preds_xgb, test_preds_xgb = predict_xgb_kfold(
        model_path='user_data/gbms_xgb.pkl',
        train=train.copy(),
        test=test.copy(),
    ...
    oof_preds_lgb, test_preds_lgb = predict_lgb_kfold(
        model_path='user_data/gbms_lgb.pkl',
        train=train,
        test=test,
        feat_cols=SAVE_FEATS,
        label_col='loan_default'
