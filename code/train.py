...
if __name__ == '__main__':
    ...
    # 模型训练
    gbms_xgb, oof_preds_xgb, test_preds_xgb = train_xgb(train.copy(), test.copy(), feat_cols=SAVE_FEATS, label_col='loan_default')
    gbms_lgb, oof_preds_lgb, test_preds_lgb = train_lgb(train, test, feat_cols=SAVE_FEATS, label_col='loan_default')
    ...
    # 结果产出
    df_submit = gen_submit_file(df_test_res, df_test_res['preds'], thres, save_path='prediction_result/result.csv')
    '''